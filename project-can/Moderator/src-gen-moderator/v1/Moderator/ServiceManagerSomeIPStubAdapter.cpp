 ...
 */
#include <v1/Moderator/ServiceManagerSomeIPStubAdapter.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createServiceManagerSomeIPStubAdapter(
    ...
    return std::make_shared< ServiceManagerSomeIPStubAdapter<::v1::Moderator::ServiceManagerStub>>(_address, _connection, _stub);
}
