 ...
 */
#ifndef V1_DES_PROJECT3_CAR__INFORMATION_SOMEIP_PROXY_HPP_
#define V1_DES_PROJECT3_CAR__INFORMATION_SOMEIP_PROXY_HPP_
...
class Car_InformationSomeIPProxy
    : virtual public Car_InformationProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    Car_InformationSomeIPProxy(
        const CommonAPI::SomeIP::Address &_address,
        const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection);

    virtual ~Car_InformationSomeIPProxy();
...
#endif // V1_DES_PROJECT3_Car__Information_SOMEIP_PROXY_HPP_
